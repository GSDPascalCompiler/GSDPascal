...
void Print(StmtType type){
	switch(type){
		...
		case S_SUB_ROUTINE: printf("SUB_ROUTINE"); break;
		case S_ROUTINE_HEAD: printf("ROUTINE_HEAD"); break;
		case S_LABEL_PART_NULL: printf("LABEL_PART_NULL"); break;
		case S_CONST_PART: printf("CONST_PART"); break;
		case S_CONST_PART_NULL: printf("CONST_PART_NULL"); break;
		case S_CONST_EXPR_LIST: printf("CONST_EXPR_LIST"); break;
		case S_CONST_EXPR: printf("CONST_EXPR"); break;
		...
		case S_TYPE_PART: printf("TYPE_PART"); break;
		case S_TYPE_PART_NULL: printf("TYPE_PART_NULL"); break;
		case S_TYPE_DECL_LIST: printf("TYPE_DECL_LIST"); break;
		case S_TYPE_DEFINITION: printf("TYPE_DEFINITION"); break;
		case S_TYPE_DECL_SIMPLE: case S_TYPE_DECL_ARRAY:case S_TYPE_DECL_RECORD:printf("TYPE_DECL"); break;
		case S_SIMPLE_TYPE_DECL_SYS: case S_SIMPLE_TYPE_DECL_ID: case S_SIMPLE_TYPE_DECL_NAME_LIST: case S_SIMPLE_TYPE_DECL_CDC: case S_SIMPLE_TYPE_DECL_MCDC:
		case S_SIMPLE_TYPE_DECL_MCDMC: case S_SIMPLE_TYPE_DECL_IDI: case S_SIMPLE_TYPE_DECL_CDI: case S_SIMPLE_TYPE_DECL_IDC: printf("SIMPLE_TYPE_DECL"); break;
		case S_ARRAY_TYPE_DECL: printf("ARRAY_TYPE_DECL"); break;
		...
		case S_VAR_PART_NULL: printf("VAR_PART_NULL"); break;
		case S_VAR_DECL_LIST: printf("VAR_DECL_LIST"); break;
		case S_VAR_DECL: printf("VAR_DECL"); break;
		case S_ROUTINE_PART_FUNC_LIST: case S_ROUTINE_PART_PROC_LIST: case S_ROUTINE_PART_FUNC_DECL: case S_ROUTINE_PART_PROC_DECL:case S_ROUTINE_NULL: printf("ROUTINE_PART"); break;
		...
		case S_PARAMETERS: printf("PARA"); break;
		case S_PARAMETERS_NULL: printf("PARA_NULL"); break;
		case S_PARA_DECL_LIST: printf("PARA_DECL_LIST"); break;
		case S_PARA_TYPE_LIST_VAR: case S_PARA_TYPE_LIST_VAL: printf("PARA_TYPE_LIST"); break;
		case S_VAR_PARA_LIST: printf("VAR_PARA_LIST"); break;
		case S_VAL_PARA_LIST: printf("VAL_PARA_LIST"); break;
		case S_ROUTINE_BODY: printf("ROUTINE_BODY"); break;
		case S_COMPOUND_STMT: printf("COUNPOUND_STMT"); break;
		case S_STMT_LIST: printf("STMT_LIST"); break;
		case S_STMT: case S_STMT_NON: printf("STMT"); break;
		...
		case S_DIRECTION_TO:  printf("DIRECTION_TO"); break;
		case S_DIRECTION_DOWNTO: printf("DIRECTION_DOWNTO"); break;
		case S_CASE: printf("CASE"); break;
		...
		case S_ARGS_LIST:  printf("ARGS_LIST"); break;
		default: printf("OTHERS:%d",type); break;
	}
}
