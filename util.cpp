...
void Print(StmtType type){
	switch(type){
		...
		case S_ROUTINE_PART_FUNC_LIST: case S_ROUTINE_PART_PROC_LIST: case S_ROUTINE_NULL: case S_ROUTINE_PART_FUNC_DECL: case S_ROUTINE_PART_PROC_DECL: printf("ROUTINE_PART"); break;
