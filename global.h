...
enum TokenType{T_READ, T_TYPE, //
 ...
 enum StmtType{S_PROGRAM, S_PROGRAM_HEAD,
	 ...
	 S_SIMPLE_TYPE_DECL_SYS, S_SIMPLE_TYPE_DECL_ID, S_SIMPLE_TYPE_DECL_NAME_LIST,S_SIMPLE_TYPE_DECL_CDC, S_SIMPLE_TYPE_DECL_MCDC, S_SIMPLE_TYPE_DECL_MCDMC, S_SIMPLE_TYPE_DECL_IDI,
	 S_ARRAY_TYPE_DECL, S_RECORD_TYPE_DECL, S_FILED_DECL_LIST, S_FILED_DECL, 
	 S_NAME_LIST, S_VAR_PART,
