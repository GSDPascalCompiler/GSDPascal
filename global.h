...
enum TokenType {
	...
	T_INTEGER, T_REAL, T_CHAR, T_STRING, T_CONST, T_ARRAY, T_VOID,//Leaf
...
enum StmtType {
	...
	S_FACTOR_ID, S_FACTOR_RECORD, S_FACTOR_FUNC, S_FACTOR_ARRAY, S_FACTOR_CONST, S_FACTOR_MINUS, S_FACTOR_NOT, S_FACTOR_SYS_ARG, S_FACTOR_SYS, S_FACTOR_SYS_ID_ARG,
...
enum AttrType { A_VOID, A_BOOLEAN, A_INTEGER, A_REAL, A_CHAR, A_STRING, A_ARRAY, A_RECORD, A_TYPE, A_PROC, A_FUNC, A_CONST_INTEGER, A_CONST_REAL, A_CONST_CHAR, A_CONST_STRING, A_WRONG_TYPE};
/*Leaf node types*/
