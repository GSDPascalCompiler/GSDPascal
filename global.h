...
enum TokenType{T_READ, T_TYPE, //
 ...
 enum StmtType{S_PROGRAM, S_PROGRAM_HEAD, S_ROUTINE, S_ROUTINE_HEAD, S_LABEL_PART_NULL,
 	...
 	S_TYPE_DEFINITION, S_SIMPLE_TYPE_DECL_CDC, S_SIMPLE_TYPE_DECL_MCDC, S_SIMPLE_TYPE_DECL_MCDMC, S_SIMPLE_TYPE_DECL_IDI,
 	S_ARRAY_TYPE_DECL, S_FILED_DECL_LIST, S_FILED_DECL, S_NAME_LIST, S_VAR_DECL_LIST,
 	S_VAR_DECL, S_VAR_PART_NULL,S_ROUTINE_PART_FUNC_LIST, S_ROUTINE_PART_PROC_LIST, S_ROUTINE_NULL, S_FUNCTION_DECL,
  ...
  S_STMT,S_STMT_LIST,S_STMT_LIST_NULL,S_COMPOUND_STMT,S_NONE};
