...
enum TokenType{T_READ, T_TYPE, //
 ...
 enum StmtType{S_PROGRAM, S_PROGRAM_HEAD,
	 ...
	 S_CONST_PART_NULL, S_CONST_EXPR_MULT_LIST, S_CONST_EXPR_LIST, S_CONST_VALUE_INT, S_CONST_VALUE_REAL, S_CONST_VALUE_CHAR, S_CONST_VALUE_STRING, S_CONST_VALUE_SYS_CON,
