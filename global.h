...
enum AttrType { A_VOID, A_BOOLEAN, A_INTEGER, A_REAL, A_CHAR, A_STRING, A_ARRAY, A_RECORD, A_TYPE, A_PROC, A_FUNC, A_CONST_INTEGER, A_CONST_REAL, A_CONST_CHAR, A_CONST_STRING };
/*Leaf node types*/
